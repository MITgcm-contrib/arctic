...
CEAW[      
      ...
      _RL vLHS1(1-OLx:sNx+OLx, 1-OLy:sNy+OLy, nSx, nSy)
      _RL uLHS2(1-OLx:sNx+OLx, 1-OLy:sNy+OLy, nSx, nSy)
      _RL vLHS2(1-OLx:sNx+OLx, 1-OLy:sNy+OLy, nSx, nSy)
      _RL uLHS3(1-OLx:sNx+OLx, 1-OLy:sNy+OLy, nSx, nSy)
      _RL vLHS3(1-OLx:sNx+OLx, 1-OLy:sNy+OLy, nSx, nSy)
