...
c     Real*8 a5d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
...
c     Real*8 e5d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      ...
      Real*8 recip_dT
      Real*8 delVdt(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
...
C-          space Centered/Upwind advection scheme, Advective form:
            ...
            DO j=jMin,jMax
             DO i=iMin,iMax
              rCenter = 0.5D0 *deltaTMom*rTrans(i,j)
