...
CBOP
C     !ROUTINE: EXCH_R8_RECV_GET_X

C     !INTERFACE:
      SUBROUTINE EXCH_R8_RECV_GET_X( array,
     ...
     &       .OR. eastCommMode .EQ. COMM_MSG ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             array(i,j,k,bi,bj) = eastRecvBuf_R8(iB,eBl,bi,bj)
            ENDDO
           ENDDO
          ENDDO
     ...
     &        .OR. westCommMode .EQ. COMM_MSG ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             array(i,j,k,bi,bj) = westRecvBuf_R8(iB,eBl,bi,bj)
            ENDDO
           ENDDO
          ENDDO
