...
C  myThid       :: my Thread Id. number
      ...
      Real*8 maskIn(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      INTEGER myThid
...
C  wT           :: vertical advective flux
      ...
      Real*8  alp  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  aln  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_v (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_v (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_o (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_o (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_x (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_x (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_y (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_y (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_z (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_z (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_xx(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_xx(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_yy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_yy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_zz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_zz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_xy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_xy(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_xz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_xz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fp_yz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8  fn_yz(1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
