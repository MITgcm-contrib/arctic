...
CBOP
C     !ROUTINE: EXCH_UV_XY_R4

C     !INTERFACE:
      SUBROUTINE EXCH_UV_XY_R4(
     U                          uPhi, vPhi,
     I                          withSigns, myThid )

C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH_UV_XY_R4
C     | o Handle exchanges for Real*4, 2-dimensional vector arrays.
C     *==========================================================*
...
C     myThid    :: my Thread Id. number
      Real*4 uPhi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*4 vPhi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      LOGICAL withSigns
      INTEGER myThid
