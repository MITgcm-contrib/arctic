...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE GSUM\Real*8\_INIT
...
CEOP
      GSR8_level = 1
      DO I = 1, lShare8
       GSR8_value(I,myThid) = 1.23456D12
      ENDDO
...
C
   ...
   10  CONTINUE
        IF ( GSR8_value(curLev,1) .NE. 1.23456D12  ) GOTO 11
        CALL FOOL_THE_COMPILER_R8( GSR8_value(1,1) )
       GOTO 10
   11  CONTINUE
       GSR8_value(curLev,myThid) = 1.23456D12
   ...
   12  CONTINUE
        ...
        nDone   = 1
        DO I = 2, nThreads
         IF ( GSR8_value(curLev,I) .NE. 1.23456D12 ) nDone = nDone+1
        ENDDO
       IF ( nDone .LT. nThreads ) GOTO 12

       GSR8_level = prevLev
       CALL FOOL_THE_COMPILER_R8( GSR8_value(1,1) )
       GSR8_value(prevLev,1) = 1.23456D12
