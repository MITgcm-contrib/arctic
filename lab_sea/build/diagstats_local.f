...
C     myThid      :: my Thread Id number
      Real*8     statFld(0:nStats,0:nRegions)
      INTEGER sizI1,sizI2,sizJ1,sizJ2
      INTEGER sizF,sizK,sizTx,sizTy
      Real*8     inpFld(sizI1:sizI2,sizJ1:sizJ2,sizK,sizTx,sizTy)
      Real*8     frcFld(sizI1:sizI2,sizJ1:sizJ2,sizF,sizTx,sizTy)
      Real*8     scaleFact
      INTEGER power
      LOGICAL useFract
