...
C     !ROUTINE: EXCH1_RL_AD

C     !INTERFACE:
      SUBROUTINE EXCH1_RL_AD(
     U                 array,
...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH1_RL_AD
C     | o Control reverse-mode edge exchanges for RL array.
C     *==========================================================*
...
C     | 3. RL arrays are used to generate code for both Real*8 and
C     | Real*8 forms.
C     *==========================================================*
...
C--   Error checks
     ...
     &  STOP ' S/R EXCH1_RL_AD: exchWidthX .GT. myOLw'
      IF ( exchWidthX .GT. myOLe   )
     &  STOP ' S/R EXCH1_RL_AD: exchWidthX .GT. myOLe'
      IF ( exchWidthY .GT. myOLs   )
     &  STOP ' S/R EXCH1_RL_AD: exchWidthY .GT. myOLs'
      IF ( exchWidthY .GT. myOLn   )
     &  STOP ' S/R EXCH1_RL_AD: exchWidthY .GT. myOLn'
      IF ( myOLw      .GT. MAX_OLX_EXCH )
     &  STOP ' S/R EXCH1_RL_AD: myOLw .GT. MAX_OLX_EXCH'
      IF ( myOLe      .GT. MAX_OLX_EXCH )
     &  STOP ' S/R EXCH1_RL_AD: myOLe .GT. MAX_OLX_EXCH'
      IF ( myOLn      .GT. MAX_OLY_EXCH )
     &  STOP ' S/R EXCH1_RL_AD: myOLn .GT. MAX_OLY_EXCH'
      IF ( myOLs      .GT. MAX_OLY_EXCH )
     &  STOP ' S/R EXCH1_RL_AD: myOLs .GT. MAX_OLY_EXCH'
      IF ( myNz       .GT. MAX_NR_EXCH  )
     &  STOP ' S/R EXCH1_RL_AD: myNz  .GT. MAX_NR_EXCH '
      IF (       theCornerMode .NE. EXCH_IGNORE_CORNERS
     &     .AND. theCornerMode .NE. EXCH_UPDATE_CORNERS
     &   ) STOP ' S/R EXCH1_RL_AD: Unrecognised cornerMode '
