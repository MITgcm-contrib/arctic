...
C     nNz   :: number of levels to process
      INTEGER nNz
      Real*8 obcs_fld_xz(1-OLx:sNx+OLx,nNz,nSx,nSy)
      Real*8 obcs_xz_0(1-OLx:sNx+OLx,nNz,nSx,nSy)
      Real*8 obcs_xz_1(1-OLx:sNx+OLx,nNz,nSx,nSy)
...
C     nNz   :: number of levels to process
      INTEGER nNz
      Real*8 obcs_fld_yz(1-OLy:sNy+OLy,nNz,nSx,nSy)
      Real*8 obcs_yz_0(1-OLy:sNy+OLy,nNz,nSx,nSy)
      Real*8 obcs_yz_1(1-OLy:sNy+OLy,nNz,nSx,nSy)
...
C     == routine arguments ==
      ...
      Real*8 obcs_fld_x(1-OLx:sNx+OLx,nSx,nSy)
      Real*8 obcs_x_0(1-OLx:sNx+OLx,nSx,nSy)
      Real*8 obcs_x_1(1-OLx:sNx+OLx,nSx,nSy)
...
C     == routine arguments ==
      ...
      Real*8 obcs_fld_y(1-OLy:sNy+OLy,nSx,nSy)
      Real*8 obcs_y_0(1-OLy:sNy+OLy,nSx,nSy)
      Real*8 obcs_y_1(1-OLy:sNy+OLy,nSx,nSy)
      CHARACTER*(MAX_LEN_FNAM) obcs_file
      CHARACTER*1 obcsmask
      LOGICAL first, changed
      LOGICAL useYearlyFields
