...
C     !LOCAL VARIABLES:
      ...
      INTEGER i, j
      INTEGER biG, bjG
      Real*8     dxLoc, dyLoc, d2Loc, d2Min
      Real*8     xLine, xy0, xyLoc, xyMin
         ...
         DO bi=myBxLo(myThid),myBxHi(myThid)
          DO j = 1,sNy+1
           DO i = 1,sNx+1
             ...
             IF ( d2Loc.LT.d2Min .OR. d2Min.EQ.-1.D0 ) d2Min = d2Loc
           ENDDO
          ENDDO
         ENDDO
        ENDDO
