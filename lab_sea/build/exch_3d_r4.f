...
CBOP
C     !ROUTINE: EXCH_3D_R4

C     !INTERFACE:
      SUBROUTINE EXCH_3D_R4(
     U                       phi,
     I                       myNz, myThid )

C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH_3D_R4
C     | o Handle exchanges for Real*4, three-dim scalar arrays.
C     *==========================================================*
...
C     myThid :: My thread id.
      INTEGER myNz
      Real*4 phi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,1:myNz,nSx,nSy)
      INTEGER myThid
