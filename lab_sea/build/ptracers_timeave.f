...
C     ptracer_full    :: cumulated time
     ...
     &                  ptracer_half   , ptracer_full
      ...
      Real*8 ptracerFluxtave(1-OLx:sNx+OLx,1-OLy:sNy+OLy,   nSx,nSy,
     &                                                     PTRACERS_num)
      Real*8 ptracertave    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy,
     &                                                     PTRACERS_num)
      Real*8 ptracer_half(nSx,nSy), ptracer_full(nSx,nSy)
...
C-    Initialize fields for the first call ever
     ...
     &                       Nr, bi, bj, myThid )
      ...
      IF ( PTRACERS_taveFreq.GT.0.D0 ) THEN
