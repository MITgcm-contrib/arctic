...
CBOP
C     !ROUTINE: EXCH_UV_DGRID_3D_R8

C     !INTERFACE:
      SUBROUTINE EXCH_UV_DGRID_3D_R8(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH_UV_DGRID_3D_R8
...
C
C  Calls: EXCH_R8 (EXCH_UV_R8_cube) ignoring sign
...
c      CALL EXCH1_UV_R8_CUBE( vPhi, uPhi, .FALSE.,
