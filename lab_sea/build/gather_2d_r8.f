...
CBOP
C !ROUTINE: GATHER_2D_R8
C !INTERFACE:
      SUBROUTINE GATHER_2D_R8(
     O                  gloBuff,
     I                  myField,
     I                  xSize, ySize,
...
C gloBuff   ( Real*8 ) :: full-domain 2D IO-buffer array             (Output)
C myField   ( Real*8 ) :: tiled, local (i.e. my Proc. tiles) 2D array (Input)
...
C myThid   (integer):: my Thread Id number
      ...
      INTEGER xSize, ySize
      Real*8     gloBuff(xSize,ySize)
      Real*8     myField(1:sNx,1:sNy,nSx,nSy)
