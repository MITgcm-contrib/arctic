...
CBOP
C     !ROUTINE: EXCH_UV_DGRID_3D_R4

C     !INTERFACE:
      SUBROUTINE EXCH_UV_DGRID_3D_R4(
     U                                 uPhi, vPhi,
     I                                 withSigns, myNz, myThid )

C     !DESCRIPTION:
C*=====================================================================*
C  Purpose: SUBROUTINE EXCH_UV_DGRID_3D_R4
...
C
C  Calls: EXCH_R4 (EXCH_UV_R4_cube) ignoring sign
...
C     == Argument list variables ==
      INTEGER myNz
      Real*4 uPhi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,myNz,nSx,nSy)
      Real*4 vPhi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,myNz,nSx,nSy)
      LOGICAL withSigns
      INTEGER myThid
...
c      CALL EXCH1_UV_R4_CUBE( vPhi, uPhi, .FALSE.,
