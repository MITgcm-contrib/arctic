...
C         parse(10) &  0  &  levels = 0  \C                   &  1  &  levels = 1  \C                   &  R  &  levels = Nr  \C                   &  L  &  levels = MAX(Nr,NrPhys)  \C                   &  M  &  levels = MAX(Nr,NrPhys) - 1  \C                   &  G  &  levels = Ground_level Number \C                   &  I  &  levels = sea-Ice_level Number \C                   &  X  &  free levels option (need to be set explicitly) \C       \end{tabular}
C     \end{center}
