...
C     ================================================================
          ...
          integer bi,bj
          Real*8 delT(1:Nr)
          Real*8 velR(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy,
     &             1:Nr)
          Real*8 facR(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy,
     &             1:Nr)
...
C     ================================================================
          integer ix,iy,ir
          Real*8 floc(    1-3:Nr+3)
          Real*8 mloc(    1-3:Nr+3)
          Real*8 fhat(1:3,1-0:Nr+0)
          Real*8 edge(    1-0:Nr+1)
          Real*8 ohat(1:2,1-3:Nr+3)
          Real*8 vsum
