...
C     |   subdomain)
C     *==========================================================*
C     |  R4 arrays are used to generate code for all 4 types
...
C     myThid      :: my Thread Id number
      ...
      Real*4     array( 1-myOLw:sNx+myOLe, 1-myOLs:sNy+myOLn,
     &               myNr, nSx, nSy )
      INTEGER exchWidthX
      INTEGER exchWidthY
      INTEGER cornerMode
      ...
      STOP 'ABNORMAL END: S/R EXCH0_R4 is empty'
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
CBOP
C     !ROUTINE: FILL_HALO_LOCAL_R4

C     !INTERFACE:
      SUBROUTINE FILL_HALO_LOCAL_R4(
     U                 locFld,
     I                 myOLw, myOLe, myOLs, myOLn, myNr,
...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE FILL_HALO_LOCAL_R4
...
C     myThid      :: thread number
      INTEGER myOLw, myOLe, myOLs, myOLn, myNr
      Real*4     locFld( 1-myOLw:sNx+myOLe, 1-myOLs:sNy+myOLn, myNr )
c     INTEGER exchWidthX, exchWidthY
      INTEGER cornerMode
      INTEGER bi, bj
      INTEGER myThid

      STOP 'ABNORMAL END: S/R FILL_HALO_LOCAL_R4 is empty'
