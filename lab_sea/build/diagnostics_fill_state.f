...
C     == Local variables ==
      ...
      Real*8 tmpMk(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 tmp1k(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 tmpU (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 tmpV (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 tmpFac, uBarC, vBarC
      INTEGER i,j,k,bi,bj
      INTEGER km1
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
         ...
         DO bj = myByLo(myThid), myByHi(myThid)
          DO bi = myBxLo(myThid), myBxHi(myThid)
           DO k=1,Nr
            DO j = 1,sNy
             DO i = 1,sNx+1
               tmpMk(i,j,k,bi,bj) = uVel(i,j,k,bi,bj)*0.5D0
         ...
         DO bj = myByLo(myThid), myByHi(myThid)
          DO bi = myBxLo(myThid), myBxHi(myThid)
           DO k=1,Nr
            DO j = 1,sNy+1
             DO i = 1,sNx
               tmpMk(i,j,k,bi,bj) = vVel(i,j,k,bi,bj)*0.5D0
         ...
         DO bj = myByLo(myThid), myByHi(myThid)
          DO bi = myBxLo(myThid), myBxHi(myThid)
           DO k=1,Nr
            ...
            DO j = 1,sNy
             DO i = 1,sNx
               tmpMk(i,j,k,bi,bj) = wVel(i,j,k,bi,bj)*0.5D0
     ...
     &       *0.5D0*(totPhiHyd(i,j,k,bi,bj)+totPhiHyd(i-1,j,k,bi,bj))
             ENDDO
            ENDDO
           ENDDO
          ENDDO
     ...
     &       *0.5D0*(totPhiHyd(i,j,k,bi,bj)+totPhiHyd(i,j-1,k,bi,bj))
             ENDDO
            ENDDO
           ENDDO
          ENDDO
...
c    &                      + drF(k)*hFacC(i,j,k,bi,bj)*0.5D0
         ...
         DO bj = myByLo(myThid), myByHi(myThid)
          DO bi = myBxLo(myThid), myBxHi(myThid)
           DO k=1,Nr
            DO j = 1,sNy
             DO i = 1,sNx
               tmpMk(i,j,k,bi,bj) = salt(i,j,k,bi,bj)-35.D0
             ENDDO
            ENDDO
           ENDDO
          ENDDO
