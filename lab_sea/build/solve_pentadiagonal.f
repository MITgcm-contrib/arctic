...
C     errCode :: > 0 if singular matrix
      ...
      Real*8 y5d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      INTEGER errCode
...
C     == Local variables ==
      ...
      Real*8 c5d_prime(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 d5d_prime(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 e5d_prime(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 y5d_prime(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
CEOP
...
C--   Init. + copy to temp. array
      DO k=1,Nr
       DO j=1-OLy,sNy+OLy
        DO i=1-OLx,sNx+OLx
         c5d_prime(i,j,k) = 0.D0
         d5d_prime(i,j,k) = 0.D0
         e5d_prime(i,j,k) = 0.D0
         y5d_prime(i,j,k) = 0.D0
