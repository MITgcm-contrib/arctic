...
C  myThid               :: my Thread Id number
      ...
      Real*8  del2w   (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  rThickC (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 recip_rThickC(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8  viscAh_W(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8  viscA4_W(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      INTEGER myThid

C !OUTPUT PARAMETERS: ==================================================
C  gwSideDrag           :: side drag tendency
      Real*8 gwSideDrag(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
