...
C     !LOCAL VARIABLES:
      ...
      Real*8 deepFac3, deepFac4
      Real*8 L2, L3, L5, L2rdt, L4rdt, recip_dt
      Real*8 Uscl,U4scl
      ...
      Real*8 sqargAh, sqargA4, sqargAhD, sqargA4D, sqargSmag
...
C---- variable viscosity :
       ...
       recip_dt = 1.D0
       IF ( deltaTMom.NE.0. ) recip_dt = 1.D0/deltaTMom
