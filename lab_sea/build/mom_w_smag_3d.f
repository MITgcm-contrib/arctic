...
C     jMin,jMax     :: 2nd  index loop ranges
      ...
      Real*8 rThickC_W    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 rThickC_S    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 rThickC_C    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 recip_rThickC(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      INTEGER iMin,iMax, jMin,jMax
      INTEGER k, bi, bj
      INTEGER myThid

C     !OUTPUT PARAMETERS:
      Real*8 wDissip(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
CEOP
