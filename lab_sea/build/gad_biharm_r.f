...
C  dfy                  :: vertical diffusive flux
      Real*8 d4f    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
...
C  gradR                :: vertical 1rst derivative of tracer (*rkSign)
      INTEGER i, j, n
      INTEGER kl, km, kp
      Real*8 del2T(1-OLx:sNx+OLx,1-OLy:sNy+OLy,1:2)
      Real*8 gradR(1-OLx:sNx+OLx,1-OLy:sNy+OLy,1:3)
      Real*8 tmpFac
CEOP
...
C     Add bi-harmonic flux (gradient of 2nd derivative)
     ...
     &              *tmpFac*rA(i,j,bi,bj)*maskUp(i,j)
        ENDDO
       ENDDO
