...
CBOP
C     !ROUTINE: EXCH_R4_RECV_GET_Y

C     !INTERFACE:
      SUBROUTINE EXCH_R4_RECV_GET_Y( array,
     ...
     &       .OR. northCommMode .EQ. COMM_MSG  ) THEN
          ...
          DO k=1,myNz
           DO j=jMin,jMax
            DO i=iMin,iMax
             iB = iB + 1
             array(i,j,k,bi,bj) = northRecvBuf_R4(iB,eBl,bi,bj)
            ENDDO
           ENDDO
          ENDDO
     ...
     &       .OR. southCommMode .EQ. COMM_MSG ) THEN
          ...
          DO k=1,myNz
           DO j=jMin,jMax
            DO i=iMin,iMax
             iB = iB + 1
             array(i,j,k,bi,bj) = southRecvBuf_R4(iB,eBl,bi,bj)
            ENDDO
           ENDDO
          ENDDO
