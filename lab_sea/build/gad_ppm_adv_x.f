...
C     ================================================================
          ...
          logical calc_CFL
          Real*8 delT
          Real*8 uvel(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy)
          Real*8 ufac(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy)
          Real*8 fbar(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy)
          Real*8 flux(1-OLx:sNx+OLx,
     &             1-OLy:sNy+OLy)
          integer myThid
...
C     ================================================================
          integer ix,iy
          Real*8 mloc(1-OLx:sNx+OLx)
          Real*8 floc(1-OLx:sNx+OLx)
          Real*8 fhat(1:3,
     &             1-OLx:sNx+OLx)
          Real*8 edge(1-OLx:sNx+OLx)
          Real*8 ohat(1:2,
     &             1-OLx:sNx+OLx)
          Real*8 vsum
...
C     ==================== zero stencil "ghost" cells along boundaries
              flux( +1-OLx+0,iy) = 0.D0
              flux( +1-OLx+1,iy) = 0.D0
              flux( +1-OLx+2,iy) = 0.D0
              flux( +1-OLx+3,iy) = 0.D0
              flux(sNx+OLx-0,iy) = 0.D0
              flux(sNx+OLx-1,iy) = 0.D0
              flux(sNx+OLx-2,iy) = 0.D0
          end do
