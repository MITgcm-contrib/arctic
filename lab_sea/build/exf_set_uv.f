...
C     myThid         :: My Thread Id number
      ...
      Real*8     uVecStartTime, uVecPeriod, uVecRepeatCycle
      Real*8     uVec_inScale
      Real*8     uVec_remove_intercept, uVec_remove_slope
      Real*8     uVec  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     uVec0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     uVec1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      CHARACTER*(*) vVecName
      CHARACTER*(128) vVecFile
      CHARACTER*1 vVecMask
      Real*8     vVecStartTime, vVecPeriod, vVecRepeatCycle
      Real*8     vVec_inScale
      Real*8     vVec_remove_intercept, vVec_remove_slope
      Real*8     vVec  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     vVec0 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     vVec1 (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     myTime
      INTEGER myIter
      INTEGER myThid
...
C !LOCAL VARIABLES:
      INTEGER i, j, bi, bj
      Real*8     tmp_u (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     tmp_v (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
CEOP
