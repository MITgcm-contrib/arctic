...
C  vT           :: meridional advective flux
      Real*8 sm_v  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_o  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_x  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_y  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_z  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_xx (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_yy (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_zz (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_xy (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_xz (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 sm_yz (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
