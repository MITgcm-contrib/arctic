...
C     |   subdomain)
C     *==========================================================*
C     |  RS arrays are used to generate code for all 4 types
...
C     myThid      :: my Thread Id number
     ...
     &               myNr, nSx, nSy )
      ...
      STOP 'ABNORMAL END: S/R EXCH0_RS is empty'
...
C---+----1----+----2----+----3----+----4----+----5----+----6----+----7-|--+----|
CBOP
C     !ROUTINE: FILL_HALO_LOCAL_RS

C     !INTERFACE:
      SUBROUTINE FILL_HALO_LOCAL_RS(
     U                 locFld,
     I                 myOLw, myOLe, myOLs, myOLn, myNr,
...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE FILL_HALO_LOCAL_RS
...
c     INTEGER exchWidthX, exchWidthY
      ...
      STOP 'ABNORMAL END: S/R FILL_HALO_LOCAL_RS is empty'
