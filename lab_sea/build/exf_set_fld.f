...
C     myThid         :: My Thread Id number
      ...
      Real*8 fld_inScale
      Real*8 fldRemove_intercept, fldRemove_slope
      Real*8 fldArr(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 fld0  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 fld1  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8     myTime
      INTEGER myIter
      INTEGER myThid
