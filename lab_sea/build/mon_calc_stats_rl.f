...
C     Calculate statistics of global array ``\Real*8 arr''.
...
C     !INPUT/OUTPUT PARAMETERS:
      ...
      Real*8 arrMask(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
        ...
        DO k=1,myNr
         DO j=1,sNy
          DO i=1,sNx
           ...
           IF ( tmpMask.GT.0.D0 .AND. noPnts ) THEN
            theMin=tmpVal
            theMax=tmpVal
            noPnts=.FALSE.
           ENDIF
           IF ( tmpMask.GT.0.D0 ) THEN
