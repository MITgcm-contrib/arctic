...
CMLC     on depth
CML      IF ( SEAICE_tensilFac .NE. 0.D0 ) THEN
CML       recip_tensilDepth = 0.D0
CML       IF ( SEAICE_tensilDepth .GT. 0.D0 )
CML     &      recip_tensilDepth = 1.D0 / SEAICE_tensilDepth
CML       DO j=jMin,jMax
CML        DO i=iMin,iMax
