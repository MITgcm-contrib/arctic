...
CBOP
C     !ROUTINE: EXCH_Z_3D_R8

C     !INTERFACE:
      SUBROUTINE EXCH_Z_3D_R8(
     U                         phi,
     I                         myNz, myThid )
      IMPLICIT NONE
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH_Z_3D_R8
C     | o Handle exchanges for Real*8, 3-dim, zeta coord arrays.
C     *==========================================================*
