...
C     myThid      :: my Thread Id number
      Real*8 str11(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 str22(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 str33(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 str12(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 str13(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1)
      Real*8 str23(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1)
      Real*8 smag3D_hLsC(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 smag3D_hLsW(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 smag3D_hLsS(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 smag3D_hLsZ(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      INTEGER k, bi, bj
      INTEGER myThid
...
C     viscAh3d_23 :: Smagorinsky viscosity @ above vVel
      Real*8 viscAh3d_00(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 viscAh3d_12(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 viscAh3d_13(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1)
      Real*8 viscAh3d_23(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr+1)
CEOP
