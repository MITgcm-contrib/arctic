...
CBOP
C !ROUTINE: SCATTER_2D_R4
C !INTERFACE:
      SUBROUTINE SCATTER_2D_R4(
     I                  gloBuff,
     O                  myField,
     I                  xSize, ySize,
...
C gloBuff   ( Real*4 ) :: full-domain 2D IO-buffer array              (Input)
C myField   ( Real*4 ) :: tiled, local (i.e. my Proc. tiles) 2D array (Output)
...
C myThid   (integer):: my Thread Id number
      ...
      INTEGER xSize, ySize
      Real*4     gloBuff(xSize,ySize)
      Real*4     myField(1:sNx,1:sNy,nSx,nSy)
