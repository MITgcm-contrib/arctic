...
CBOP
C     !ROUTINE: EXCH_S3D_R8

C     !INTERFACE:
      SUBROUTINE EXCH_S3D_R8(
     U                       phi,
     I                       myNz, myThid )

C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH_S3D_R8
C     | o Handle Simple exchanges (= that ignore corners)
C     |   for Real*8, 3-dim scalar arrays with overlap size = 1
C     *==========================================================*
...
C     myThid :: My thread id.
      INTEGER myNz
      Real*8 phi(0:sNx+1,0:sNy+1,myNz,nSx,nSy)
      INTEGER myThid
