...
C     !ROUTINE: EXCH_R4_SEND_PUT_X

C     !INTERFACE:
      SUBROUTINE EXCH_R4_SEND_PUT_X( array,
...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH_R4_SEND_PUT_X
C     | o "Send" or "put" X edges for R4 array.
C     *==========================================================*
         ...
         IF ( westCommMode .EQ. COMM_MSG  ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             westSendBuf_R4(iB,eBl,bi,bj) = array(i,j,k,bi,bj)
            ENDDO
           ENDDO
          ENDDO
         ELSEIF ( westCommMode .EQ. COMM_PUT  ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             eastRecvBuf_R4(iB,eBl,biW,bjW) = array(i,j,k,bi,bj)
            ENDDO
           ENDDO
          ENDDO
         ...
         IF ( eastCommMode .EQ. COMM_MSG  ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             eastSendBuf_R4(iB,eBl,bi,bj) = array(i,j,k,bi,bj)
            ENDDO
           ENDDO
          ENDDO
         ELSEIF ( eastCommMode .EQ. COMM_PUT  ) THEN
          ...
          DO k=1,myNz
           DO j=1,sNy
            DO i=iMin,iMax
             iB = iB + 1
             westRecvBuf_R4(iB,eBl,biE,bjE) = array(i,j,k,bi,bj)
            ENDDO
           ENDDO
          ENDDO
