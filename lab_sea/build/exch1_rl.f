...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE EXCH1_RL
C     | o Control forward-mode edge exchanges for RL array.
C     *==========================================================*
...
C--   Error checks
     ...
     &  STOP ' S/R EXCH1_RL: exchWidthX .GT. myOLw'
      IF ( exchWidthX .GT. myOLe   )
     &  STOP ' S/R EXCH1_RL: exchWidthX .GT. myOLe'
      IF ( exchWidthY .GT. myOLs   )
     &  STOP ' S/R EXCH1_RL: exchWidthY .GT. myOLs'
      IF ( exchWidthY .GT. myOLn   )
     &  STOP ' S/R EXCH1_RL: exchWidthY .GT. myOLn'
      IF ( myOLw      .GT. MAX_OLX_EXCH )
     &  STOP ' S/R EXCH1_RL: myOLw .GT. MAX_OLX_EXCH'
      IF ( myOLe      .GT. MAX_OLX_EXCH )
     &  STOP ' S/R EXCH1_RL: myOLe .GT. MAX_OLX_EXCH'
      IF ( myOLn      .GT. MAX_OLY_EXCH )
     &  STOP ' S/R EXCH1_RL: myOLn .GT. MAX_OLY_EXCH'
      IF ( myOLs      .GT. MAX_OLY_EXCH )
     &  STOP ' S/R EXCH1_RL: myOLs .GT. MAX_OLY_EXCH'
     ...
     &   ) STOP ' S/R EXCH1_RL: Unrecognised cornerMode '
