...
C  myThid           :: thread number
      ...
      Real*8 uFld      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 vFld      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
...
C  gTr_trp          :: passive tracer total transport tendency before gchem
      ...
      Real*8 rTransKp(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 fZon    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 fMer    (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 fVer    (1-OLx:sNx+OLx,1-OLy:sNy+OLy,2)
      Real*8 gTracer (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 gTrForc (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 gTr_AB  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      LOGICAL calcAdvection
      INTEGER iterNb
      Real*8 dummy(Nr)
      Real*8 gTr_trp (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 recip_dt
