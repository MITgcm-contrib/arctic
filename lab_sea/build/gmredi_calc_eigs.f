...
C     bi, bj    :: tile indices
      ...
      Real*8 mask(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 hfac(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 recip_hfac(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 rlow(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 N2(  1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 Rmid(1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 vec(nmodes,1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
