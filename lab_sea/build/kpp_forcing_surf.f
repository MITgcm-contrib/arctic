...
C                            at grid levels for bldepth             (m^2/s^2)
      ...
      Real*8 rhoSurf     (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      Real*8 surfForcU   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 surfForcV   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 surfForcT   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 surfForcS   (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 surfForcTice(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      ...
      Real*8 SPforcS     (1-OLx:sNx+OLx, 1-OLy:sNy+OLy, Nr       )
      Real*8 SPforcT     (1-OLx:sNx+OLx, 1-OLy:sNy+OLy, Nr       )
      Real*8 boplume     (1-OLx:sNx+OLx, 1-OLy:sNy+OLy, Nrp1     )
...
C Local constants
      ...
      Real*8 tempvar2, epsLoc, epsLocSq
      Real*8 recip_Cp
...
CML        work3(i,j) = 1.D0 / rhoSurf(i,j)
CML       ENDDO
CML      ENDDO
