...
C  arrayout    ( Real*8 )   :: output array
...
C  myThid      (integer) :: My Thread Id number
      ...
      Real*8           arrayout(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
...
C     arrayin     :: input field array (loaded from file)
      Real*8      arrayin( -1:nxIn+2, -1:nyIn+2 )
      ...
      Real*8      threeSixtyRS
      Real*8      yPole, symSign, poleValue
