...
C     i, k   :: Loop counters.
     ...
     & '   /* Reference salinity profile ( g/kg ) */')
...
C-----
     ...
     & ' /* Linear EOS haline contraction coefficient ( 1/(g/kg) ) */')
...
C-----
     ...
     &  'salt_EvPrRn =',
     &  ' /* Salin. of Evap/Prec/R (UNSET=use local S)(g/kg)*/')
