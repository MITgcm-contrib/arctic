...
c     Real*8 maskUp  (1-OLx:sNx+OLx,1-OLy:sNy+OLy)
      ...
      Real*8 rTran3d (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 afr     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      ...
      Real*8 localT3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr)
      Real*8 kp1Msk
