...
C--   Default values GM/Redi
      ...
      GM_isopycK          = -999.
      GM_background_K     = 0.D0
      GM_maxSlope         = 1.D-2
      GM_Kmin_horiz       = 0.D0
      GM_Small_Number     = 1.D-20
      GM_slopeSqCutoff    = 1.D+48
      GM_taper_scheme     = ' '
      GM_facTrL2dz        = 1.
      GM_facTrL2ML        = 5.
      GM_maxTransLay      = 500.
...
C--   Default values Sub-Meso (corresponding tau = 5.8 days):
      GM_useSubMeso = .FALSE.
      subMeso_invTau =  2.0D-6
      subMeso_LfMin  =  1.0D+3
      subMeso_Ceff   =  7.0D-2
...
C--   Default values Visbeck
      ...
      GM_Visbeck_minDepth =    0.D0
      GM_Visbeck_maxSlope = UNSET_RL
      GM_Visbeck_minVal_K =    0.D0
...
C--   Default values GEOMETRIC
      ...
      GEOM_alpha              = 0.D0
      GEOM_ini_EKE            = 1.D-3
      GEOM_diffKh_EKE         = 1.D+3
      GEOM_vert_struc         = .FALSE.
      GEOM_vert_struc_min     = 1.D-1
      GEOM_vert_struc_max     = 1.D0
      GEOM_minVal_K           = 0.D0
      GEOM_maxVal_K           = 2500.D0
...
C--   Default values for BatesK3d
      ...
      GM_Bates_maxC      = 0.15D0
      GM_Bates_Rmax      = 75.D3
      GM_Bates_Rmin      = 30.D3
      GM_Bates_minCori   = zeroRL
      GM_Bates_minN2     = 1.D-8
...
C     Some constants
      GM_rMaxSlope = 0.D0
      IF (GM_maxSlope.NE.zeroRL) GM_rMaxSlope = 1.D0 / GM_maxSlope
...
C     Set (or reset) some switches:
     ...
     &       GM_useBatesK3d .OR. GM_useLeithQG ) ) THEN
      ...
      IF (GM_UseBVP) THEN
        GM_BVP_rModeNumber = 1.D0/DBLE(GM_BVP_ModeNumber)
