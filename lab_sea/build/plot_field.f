...
C--                      implementation.
C--    Contents
C--    o plot_field_xyrs  - Writes a XY  Real*8 field
C--    o plot_field_xyrl  - Writes a XY  Real*8 field
C--    o plot_field_xyzrs - Writes a XYZ Real*8 field
C--    o plot_field_xyzrl - Writes a XYZ Real*8 field
      SUBROUTINE PLOT_FIELD_XYRS( 
     I                            fld, fldNam , myIter, myThid )

C     /==========================================================C     | SUBROUTINE PLOT_FIELD_XYRS                               |
...
C     /==========================================================C     | SUBROUTINE PLOT_FIELD_XYRL                               |
C     | Print out an XY Real*8 field using text map.                |
C     |==========================================================|
C     | This routine references "numerical model" parameters like|
C     | like the integration time. It uses these to create a     |
...
C     /==========================================================C     | SUBROUTINE PLOT_FIELD_XYZR4                              |
...
C     | point etc..                                              |
C     | Other plot formats can also be substituted here.         |
C     | Real*8 is usually a REAL*4 field                            |
C     \==========================================================/
      IMPLICIT NONE
...
C     /==========================================================C     | SUBROUTINE PLOT_FIELD_XYZRL                              |
C     | Print out an XYZ Real*8 field using text map.               |
C     |==========================================================|
C     | This routine references "numerical model" parameters like|
C     | like the integration time. It uses these to create a     |
...
C     | point etc..                                              |
C     | Other plot formats can also be substituted here.         |
C     | Real*8 is usually a REAL*8 field                            |
C     \==========================================================/
      IMPLICIT NONE
