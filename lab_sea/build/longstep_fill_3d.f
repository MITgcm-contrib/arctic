...
CBOP
C     !ROUTINE: LONGSTEP_FILL_3D
C     !INTERFACE:
      SUBROUTINE LONGSTEP_FILL_3D(
     U      lsCnt, lsFld,
     I      fld, myNr, myThid)

C     !DESCRIPTION: \bv
C     *==========================================================*
C     | SUBROUTINE LONGSTEP_FILL_3D
...
C     myThid :: my Thread Id number
      INTEGER myNr
      Real*8 lsFld(1-OLx:sNx+OLx,1-OLy:sNy+OLy,myNr,nSx,nSy)
      Real*8 Fld(1-OLx:sNx+OLx,1-OLy:sNy+OLy,myNr,nSx,nSy)
