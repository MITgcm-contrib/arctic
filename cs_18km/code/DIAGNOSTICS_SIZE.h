C $Header: /u/gcmpack/MITgcm_contrib/arctic/cs_18km/code/DIAGNOSTICS_SIZE.h,v 1.1 2013/12/24 00:08:45 atn Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      PARAMETER( numlists = 57, numperlist = 50, numLevels=Nr )
